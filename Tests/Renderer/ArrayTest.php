 ...
 */
require_once realpath(dirname(__FILE__) . '/../../Formagic/Renderer/Array.php');
require_once realpath(dirname(__FILE__) . '/../../Formagic/Rule/Abstract.php');
 ...
 * @author      Florian Sonnenburg
 * @copyright   Copyright (c) 2007-2011 Florian Sonnenburg
 * @version     $Id: ArrayTest.php 173 2012-05-16 13:19:22Z meweasle $
 **/
