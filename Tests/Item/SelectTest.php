 ...
 * Load input item
 */
require_once realpath(dirname(__FILE__) . '/../../Formagic/Item/Select.php');
...
class Formagic_Item_Select_Test extends PHPUnit_Framework_TestCase
{
    ...
    public function testFilterWithArrayValue()
    {
        ...
        $expected = array(
            'key1' => Formagic_Filter_MockFilter::FILTERED_VALUE,
            'key2' => Formagic_Filter_MockFilter::FILTERED_VALUE,
            'key3' => array(
                'key3_1' => Formagic_Filter_MockFilter::FILTERED_VALUE,
                'key3_2' => Formagic_Filter_MockFilter::FILTERED_VALUE,
            )
        );
