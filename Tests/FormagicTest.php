...
class Formagic_Test extends PHPUnit_Framework_TestCase
{
    ...
    public function testAddItem()
    {
        ...
        $formagic->addItem('MockItem', $mockItemName2);
        $__getItem = $formagic->test2;
        $this->assertInstanceOf('Formagic_Item_MockItem', $__getItem);
     ...
     * @runInSeparateProcess
     */
    public function testAddBaseDirByStaticMethod()
    {
        $newBaseDir = realpath('.');
     ...
     * @runInSeparateProcess
     */
    public function testAddBaseDirByOption()
    {
        $newBaseDir = realpath('.');
