...
/**
 * Load SessionValue rule class
 */
require_once dirname(__FILE__) . '/../../Formagic/Rule/SessionValue.php';

/**
 * Load Formagic Session Interface
 */
require_once dirname(__FILE__) . '/../../Formagic/Session/Interface.php';
require_once dirname(__FILE__) . '/../../Formagic/Session/Exception.php';
 ...
 * @author      Florian Sonnenburg
 * @copyright   Copyright (c) 2007-2012 Florian Sonnenburg
 * @version     $Id: SessionValueTest.php 173 2012-05-16 13:19:22Z meweasle $
 **/
