...
/**
 * Load mock input class
 */
require_once realpath(dirname(__FILE__) . '/../MockClasses/Item/MockItem.php');
...
class Formagic_Item_Abstract_Test extends PHPUnit_Framework_TestCase
{
    ...
    {
        $input = new Formagic_Item_MockItem('test');
        ob_start();
        $res = $input->printInfo();
        $this->assertNull($res);
        $info = ob_get_clean();
    ...
    public function testGetName()
    {
        ...
        $input      = new Formagic_Item_MockItem($name);
    ...
    {
        Formagic::loadClass('Formagic_Filter_MockFilter');
        Formagic::loadClass('Formagic_Filter_MockFilter2');

        // add as instance
        $filter = new Formagic_Filter_MockFilter();
        $input  = new Formagic_Item_MockItem('test');
        $input->addFilter($filter);
        $hasFilter = $input->hasFilter('MockFilter');
        $this->assertEquals($hasFilter, true);

        // add as instance on instantiation, single
        $input  = new Formagic_Item_MockItem('test', array('filters' => $filter));
        $hasFilter = $input->hasFilter('MockFilter');
        $this->assertEquals($hasFilter, true);

        // add as instance on instantiation, multi
        $filter2 = new Formagic_Filter_MockFilter2();
        $input  = new Formagic_Item_MockItem('test', array(
            'filters' => array($filter, $filter2)
        ));
        $hasFilter = $input->hasFilter('MockFilter');
        $hasFilter2 = $input->hasFilter('MockFilter2');
        $this->assertEquals($hasFilter, true);
        $this->assertEquals($hasFilter2, true);

        // add as string
        $input->addFilter('MockFilter');
        $hasFilter = $input->hasFilter('MockFilter');
        $this->assertEquals($hasFilter, true);
        ...
        $filter2 = new Formagic_Filter_MockFilter2();
        $input  = new Formagic_Item_MockItem('test', array(
            'filters' => array('MockFilter', 'MockFilter2')));
        $hasFilter = $input->hasFilter('MockFilter');
        $hasFilter2 = $input->hasFilter('MockFilter2');
        $this->assertEquals($hasFilter, true);
        $this->assertEquals($hasFilter2, true);
    ...
    public function testGetUnfilteredValue()
    {
        ...
        $input = new Formagic_Item_MockItem('test', array('value' => $value));
    ...
    public function testGetValue()
    {
        ...
        $this->assertSame(Formagic_Filter_MockFilter::FILTERED_VALUE, $actualValue);
    }
    ...
    {
        $itemLabel = 'testLabel';
        $item = new Formagic_Item_MockItem('testItem', array('label' => $itemLabel));
    ...
    {
        $item = new Formagic_Item_MockItem('testItem');
    ...
    public function testGetNameAttribute()
    {
        ...
        $item = new Formagic_Item_MockItem($itemName);
    ...
    public function testGetAttributes()
    {
        ...
        // set by options
        $item = new Formagic_Item_MockItem('testItem', array(
    ...
    public function testGetAttributeStr()
    {
        ...
        $item = new Formagic_Item_MockItem('item[key][]', array(
    ...
    public function testAddRule()
    {
        ...
        $item = new Formagic_Item_MockItem('test');
        $res = $item->addRule('MockRule');
        $this->assertSame($item, $res);

        // set by method and object
        Formagic::loadClass('Formagic_Rule_MockRule');
        $item = new Formagic_Item_MockItem('test');
        $res = $item->addRule(new Formagic_Rule_MockRule());
        $this->assertSame($item, $res);
    }
    ...
    {
        $ruleName = 'MockRule';
        $ruleName2 = 'MockRuleTrue';

        // set by option and string
        $item = new Formagic_Item_MockItem('test', array(
            'rules' => $ruleName
        ));
        ...
        Formagic::loadClass('Formagic_Rule_MockRule');
        $item = new Formagic_Item_MockItem('test', array(
            'rules' => new Formagic_Rule_MockRule()
        ));
        $hasRule = $item->hasRule($ruleName);
        $this->assertTrue($hasRule);
        ...
        // set by option and object
        Formagic::loadClass('Formagic_Rule_MockRuleTrue');
        $item = new Formagic_Item_MockItem('test', array(
            'rules' => array(
                new Formagic_Rule_MockRule(),
                new Formagic_Rule_MockRuleTrue()
            )
        ));
        $hasRule = $item->hasRule($ruleName);
        $hasRule2 = $item->hasRule($ruleName2);
    ...
    public function testGetViolatedRules()
    {
        ...
        // one rule, validates false
        Formagic::loadClass('Formagic_Rule_MockRuleFalse');
        $rule2 = new Formagic_Rule_MockRuleFalse();
        $item
            ->setValue('0')
            ->addRule($rule2)
            ->validate();
    ...
    public function testSetReadonly()
    {
        ...
        $this->assertInstanceOf('Formagic_Item_MockItem', $res);

        $html = $item->getHtml();
        $this->assertEquals($html, Formagic_Item_MockItem::HTML_OUTPUT_READONLY);

        $item->setReadonly(false);
        $html = $item->getHtml();
        $this->assertEquals($html, Formagic_Item_MockItem::HTML_OUTPUT);

        // set readonly by option
        $item = new Formagic_Item_MockItem('test', array('readonly' => true));
        $html = $item->getHtml();
        $this->assertEquals($html, Formagic_Item_MockItem::HTML_OUTPUT_READONLY);

        $item = new Formagic_Item_MockItem('test', array('readonly' => false));
        $html = $item->getHtml();
        $this->assertEquals($html, Formagic_Item_MockItem::HTML_OUTPUT);
    }
    ...
    public function testSetHidden()
    {
        ...
        // set by option
        $item = new Formagic_Item_MockItem('test', array('hidden' => true));
        $isHidden = $item->isHidden();
        $this->assertTrue($isHidden);

        $item = new Formagic_Item_MockItem('test', array('hidden' => false));
        $isHidden = $item->isHidden();
        $this->assertFalse($isHidden);
    }
    ...
    public function testSetIgnore()
    {
        ...
        // set by option
        $item = new Formagic_Item_MockItem('test', array('ignore' => true));
        $isIgnored = $item->isIgnored();
        $this->assertTrue($isIgnored);

        $item = new Formagic_Item_MockItem('test', array('ignore' => false));
        $isIgnored = $item->isIgnored();
        $this->assertFalse($isIgnored);
    }
    ...
    public function testSetDisabled()
    {
        ...
        // set by option
        $item = new Formagic_Item_MockItem('test', array('disable' => true));
        $isDisabled = $item->isDisabled();
        $this->assertTrue($isDisabled);

        $item = new Formagic_Item_MockItem('test', array('disable' => false));
        $isDisabled = $item->isDisabled();
        $this->assertFalse($isDisabled);
    }
