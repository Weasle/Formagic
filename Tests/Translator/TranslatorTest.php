 ...
 */
require_once(dirname(__FILE__) . '/../MockClasses/Translator/MockupTranslator.php');
require_once(dirname(__FILE__) . '/../MockClasses/Translator/MockupSubclass.php');
 ...
 * @version     $Id: TranslatorTest.php 173 2012-05-16 13:19:22Z meweasle $
 **/
class Formagic_Translator_Test extends PHPUnit_Framework_TestCase
{
    ...
    {
        $translatorDefinition = new Test_Formagic_Translator_MockupSubclass();
        $expected = $translatorDefinition->_('test');

        $this->_formagic->setTranslator($translatorDefinition);
        $translator = $this->_formagic->getTranslator();
        $this->assertInstanceOf('Test_Formagic_Translator_MockupSubclass', $translator);
    ...
    {
        $translatorDefinition = new Test_Formagic_Translator_MockupTranslator();
        $expected = $translatorDefinition->_('test');
